...
class DB:
    ...
    def create(self, event: model.Event):
        try:
            ...
            raise DB_Exception('Failed to create an event')
    ...
    def list(self):
        try:
            ...
            raise DB_Exception('Failed to list events')
    ...
    def read(self, event_id: str):
        try:
            ...
            raise DB_Exception('Event not found')
    ...
    def update(self, event_id: str, event: model.Event):
        try:
            ...
            raise DB_Exception('Failed to update')
    ...
    def delete(self, event_id: str):
        try:
            ...
            raise DB_Exception('Failed to delete')